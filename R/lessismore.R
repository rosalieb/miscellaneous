...
packages <- c("base","mgcv","ggplot2", "FSA")
# path2file<-"/Volumes/-/Script R/LEM10_CC/scriptRosalie060317.R"
path2file<-"/Volumes/-/Script R/LEM10_CC/LEM10_CC_20190416.Rmd"
# tmp<- getParseData(parse(path2file, keep.source = TRUE))
# View(tmp)
